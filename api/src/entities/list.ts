...
export class List extends BaseEntity {
  ...
  getFormattedList(): any {
    return {
      ...
      owner: this.owner?.getFormattedUser ? this.owner.getFormattedUser() : this.owner,
      sharedWith: this.sharedWith ? this.sharedWith.map(user => (user.getFormattedUser ? user.getFormattedUser() : user)) : [],
